...
class Localisation:
    ...
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Nevertheless, trying to upload."
    ...
    DELETED_CUSTOM_THUMB_NAIL = "✂️ Custom thumbnail cleared successfully."
    
    DELETED_CUSTOM_MEDIA = "✂️ Media cleared successfully."
    
    SAVED_RECEIVED_DOC_FILE = "✂️ Downloaded Successfully."
